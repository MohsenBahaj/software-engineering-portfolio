...
- **Deployed and managed the backend on a VPS using Docker Compose**  
  I containerized and orchestrated the backend services using Docker Compose on a production VPS, handling deployment, service coordination, and environment configuration.

- **Configured Nginx as a reverse proxy with custom domain routing**  
  I set up and configured Nginx to act as a reverse proxy, routing traffic to the appropriate backend services based on custom domain rules.

- **Set up and deployed n8n workflow automation on the same VPS**  
  I deployed n8n as a workflow automation platform on the same VPS, integrating it into the overall service infrastructure.

- **Deployed the admin dashboard on VPS with a dedicated subdomain**  
  I deployed the admin-facing dashboard on the VPS and assigned it a dedicated subdomain for isolated access and management.

- **Configured custom domains for all services (api.domain.com, admin.domain.com, n8n.domain.com)**  
  I configured DNS records and Nginx server blocks to expose each service under its own subdomain, providing clean, production-appropriate URLs for the API, admin dashboard, and automation platform.
...
<div align="center">
  <table style="width: 100%; border-collapse: collapse;">
    ...
    <tr>
      ...
      <td width="33.33%" align="center">
        <img src="screenshots/payment%20gartway%20screen.jpeg" width="90%" alt="Payment Gateway"/><br/>
        <b>Payment Gateway</b>
      </td>
    </tr>
  </table>
